  ...
  return (
    ...
    <div className="container">
      <div className="ms-[180px] flex  sm:ms-[40px]">
        ...
        <div className="ms-[74px] w-[575px] h-[470px] bg-[#9797971F]"><img src={story.img} className="absolute ms-[25px] mt-[25px] sm:ms-[25px] h-[410px] w-[480px] mt-[30px] mb-[121px]"/></div>
      </div>
      </div>
    </>
  );

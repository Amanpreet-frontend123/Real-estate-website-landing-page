...
const Herosection = () => {
  return (
    <>
      <div className="flex w-full bg-black text-white py-12 px-4">
        <div className="">
        ...
        <div className="" >
          ...
          <div className="absolute -m-50  p-10   gap-10 h-[144px] w-[745px]  bg-linear-to-r from-cyan-500 to-blue-500 flex justify-evenly">
            <div>
